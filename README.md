...
关注政治及组织结构与数字、智能技术之间的张力，探索计算社会科学、AI 治理与面向人文社会科学的研究基础设施。
...
- **政治与组织结构**：技术如何进入既有制度、组织与权力关系，又如何受到它们的塑造。
- **数字治理与 AI 治理**：智能系统的责任边界、审查机制、人工决策权与制度条件。
- **计算社会科学**：文本即数据、测量、因果推断，以及计算方法与理论问题之间的适配。
- **研究基础设施**：把文献、证据、主张、代码、审查和写作组织成可追溯、可复核的工作流。
...
1. **问题先于方法**：从政治现象、概念和机制出发，再选择计算工具。
2. **证据先于表达**：区分材料、测量、推断、解释和规范判断。
3. **成品接受检验**：以可复核的论文、报告、数据或软件，而不是 Agent 的自我陈述为准。
4. **关键判断由人负责**：核心概念、理论框架、伦理批准与最终主张保留人工决策权。

---

目前主要使用 Python、JavaScript / TypeScript、Shell、Markdown / Quarto 与现代 AI 编码工具构建研究工作流。项目仍在持续整理和验证中；欢迎通过相关仓库的 Issue 讨论具体问题。
